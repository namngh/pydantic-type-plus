...
class UInt32(bytes):
    ...
    def __add__(self, other):
        if isinstance(other, UInt32) or isinstance(other, bytes):
            other = int.from_bytes(other, "little")

        return UInt32.validate(int.from_bytes(self, "little") + other)
    ...
    def __invert__(self):
        return UInt32.validate(~int.from_bytes(self, "little"))
    ...
    def __repr__(self):
        return f'UInt32({int.from_bytes(self, "little")})'
